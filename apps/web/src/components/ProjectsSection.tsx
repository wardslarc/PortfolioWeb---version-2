                    ...
                    <div className="flex flex-col gap-2 mt-auto">
                      {project.demoUrl && project.demoUrl !== "#" && (
                        <Button
                          ...
                          // Centralize outbound-link validation instead of
                          // opening arbitrary URLs directly from project data.
                          onClick={() => safeWindowOpen(project.demoUrl)}
                        >
                          Visit Website
                        </Button>
                      )}
